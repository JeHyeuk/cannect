...
# vc = DataBaseCAN.VersionControl(r"자체제어기_KEFICO-EMS_CANFD.xlsx") # 상동
# vc = DataBaseCAN.VersionControl(r"G-PROJECT_KEFICO-EMS_CANFD.xlsx") # G프로젝트용
